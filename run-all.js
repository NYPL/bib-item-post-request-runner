...
// Build base logging path using env (e.g. production):
const loggingNamespace = path.basename(argv.envfile, '.env')
const multiReposter = new MultiReposter({ loggingNamespace })
